      ...
      NewProjectAudioProcessor::createParameterLayout()
{
  juce::AudioProcessorValueTreeState::ParameterLayout layout
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("Peak Quality","Peak Quality",juce::NormalisableRange<float>(-24.f,24.f,1.f,1.f),0.0f));
    ...
    layout.add(std::make_unique<juce::AudioParameterChoice>("LowCutk Slope","LowCut Slope",StringArray,0));
